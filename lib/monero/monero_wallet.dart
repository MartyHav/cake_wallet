...
abstract class MoneroWalletBase extends WalletBase<MoneroBalance,
  ...
  Future<void> init() async {
    ...
    balance = getHavenBalance(accountIndex: walletAddresses.account.id)[selectedAsset];
    _setListeners();
  ...
  Future<PendingTransaction> createTransaction(Object credentials) async {
    ...
    final unlockedBalance =
        getHavenBalance(accountIndex: walletAddresses.account.id)[selectedAsset]
            .unlockedBalance;
  ...
  int _getHavenFullBalance() =>
      getHavenBalance(accountIndex: walletAddresses.account.id)[selectedAsset].fullBalance;

  int _getHavenUnlockedBalance() =>
      getHavenBalance(accountIndex: walletAddresses.account.id)[selectedAsset].unlockedBalance;
